...
def train_embeddings(args):
    root = "./../embeddings"
    for corpus in [args.src_file, args.trg_file]:
...
def main():
    ...
    parser.add_argument('--src_file', type = str, default = './../datasets/processed/cleaned_corpus.src')
    parser.add_argument('--trg_file', type = str, default = './../datasets/processed/cleaned_corpus.trg')
