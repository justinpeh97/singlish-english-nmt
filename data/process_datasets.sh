...
python dataset_processing.py --input_file ./datasets/raw/raw_singlish.txt --output_file ./datasets/processed/cleaned_singlish.txt  --lower --tokenize --clean_text --english_to_singlish --filtering
python dataset_processing.py --input_file ./datasets/raw/raw_reddit.txt --output_file ./datasets/processed/cleaned_reddit.txt  --lower --tokenize